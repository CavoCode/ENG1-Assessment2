package com.mygdx.pirategame.main;
...
public class PirateGame extends Game {
	...
	public static final short FIRE_BIT = 512;
	...
	public void create () {
		...
		song = Gdx.audio.newMusic(Gdx.files.internal("sounds/pirate-music.mp3"));
	...
	public void changeScreen(int screen) {
		...
		switch (screen) {
			...
			case GAME:
				...
				if (gameScreen == null) gameScreen = new GameScreen(this, false);
				this.setScreen(gameScreen);
				break;

			case SKILL:
				if (skillTreeScreen == null) skillTreeScreen = new SkillTree(this, gameScreen.player);
